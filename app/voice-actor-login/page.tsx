      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-purple-500 to-pink-600 p-8 text-white text-center">
            ...
            <h1 className="text-3xl font-bold mb-2">Seslendirmen Girişi</h1>
            <p className="text-purple-100">İşlerinizi yönetin</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-8">
            <div className="space-y-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3 bg-gradient-to-r from-purple-500 to-pink-600 text-white rounded-xl font-semibold hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
